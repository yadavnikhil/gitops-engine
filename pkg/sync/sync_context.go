...
// WithServerSideDryRun allows to switch between server side and client side dry run
func WithServerSideDryRun(serverSideDryRun bool) SyncOpt {
	return func(ctx *syncContext) {
		ctx.serverSideDryRun = serverSideDryRun
	}
}
